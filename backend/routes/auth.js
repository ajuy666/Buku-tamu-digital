// ===============================================
// 🔐 UNIVERSAL LOGIN FINAL
// Superadmin → Subadmin → Admin (fix konflik username)
// ===============================================
  ...
  router.post("/login", async (req, res) => {
    ...
    try {
      ...
      const subRes = await pool.query(
        "SELECT * FROM public.subadmin WHERE username = $1 LIMIT 1",
        [username]
      );
      ...
      if (subRes.rows.length > 0) {
        ...
        // 🛑 Status inactive → tidak boleh login
